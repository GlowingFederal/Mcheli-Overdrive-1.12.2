...
public class MCH_ItemUavStation extends W_Item {
  ...
  public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
    ...
    double d1 = playerIn.field_70167_r + (playerIn.field_70163_u - playerIn.field_70167_r) * f + 1.62D;
    ...
    if (W_MovingObjectPosition.isHitTypeTile(movingobjectposition)) {
      ...
      int rot = (int)(MCH_Lib.getRotate360(playerIn.field_70177_z) + 45.0D);
      entityUavSt.field_70177_z = (rot / 90 * 90 - 180);
      entityUavSt.initUavPostion();
      if (!worldIn.func_184144_a((Entity)entityUavSt, entityUavSt.func_174813_aQ().func_72314_b(-0.1D, -0.1D, -0.1D)).isEmpty())
        return ActionResult.newResult(EnumActionResult.FAIL, itemstack); 
