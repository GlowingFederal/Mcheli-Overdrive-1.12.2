...
public class ObjParser {
  ...
  public static ObjModel parse(InputStream inputStream) throws DebugException {
    ...
    try {
      ...
      groupObjects.add(group.build());
      return new ObjModel(groupObjects, vertexNum, faceNum);
    } catch (IOException e) {
  ...
  private static _Vertex parseVertex(String line, int lineCount) throws DebugException {
    ...
    if (isValidVertexLine(line)) {
      ...
      try {
        ...
        throw new DebugException(String.format("Number formatting error at line %d", new Object[] { Integer.valueOf(lineCount) }), e);
      } 
    } else {
