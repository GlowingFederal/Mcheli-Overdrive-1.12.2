...
public class MCH_EntityParticleExplode extends MCH_EntityParticleBase {
  ...
  public void renderParticle(BufferBuilder buffer, Entity entityIn, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_) {
    ...
    if (i <= 15) {
      ...
      buffer.pos((f11 - p_70539_3_ * f10 - p_70539_6_ * f10), (f12 - p_70539_4_ * f10), (f13 - p_70539_5_ * f10 - p_70539_7_ * f10))
        .tex(f7, f9)
        .color(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).lightmap(k, l)
