...
public class MCH_ParticlesUtil {
  public static void spawnParticleExplode(World w, double x, double y, double z, float size, float r, float g, float b, float a, int age) {
    ...
    epe.setAlphaF(a);
    (FMLClientHandler.instance().getClient()).effectRenderer.addEffect((Particle)epe);
  }
  ...
  public static Particle doSpawnParticle(String type, double x, double y, double z, double mx, double my, double mz, int... params) {
    ...
    if (mc != null && mc.getRenderViewEntity() != null && mc.effectRenderer != null) {
      ...
      if (type.equalsIgnoreCase("hugeexplosion")) {
        entityfx = create(net.minecraft.client.particle.ParticleExplosionHuge.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
        mc.effectRenderer.addEffect(entityfx);
      } else if (type.equalsIgnoreCase("largeexplode")) {
        entityfx = create(net.minecraft.client.particle.ParticleExplosionLarge.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
        mc.effectRenderer.addEffect(entityfx);
      } else if (type.equalsIgnoreCase("fireworksSpark")) {
        entityfx = create(net.minecraft.client.particle.ParticleFirework.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
        mc.effectRenderer.addEffect(entityfx);
      } 
      if (entityfx != null)
        return entityfx; 
      ...
      if (type.equalsIgnoreCase("bubble")) {
        entityfx = create(net.minecraft.client.particle.ParticleBubble.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("suspended")) {
        entityfx = create(net.minecraft.client.particle.ParticleSuspend.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("depthsuspend")) {
        entityfx = create(net.minecraft.client.particle.ParticleSuspendedTown.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("townaura")) {
        entityfx = create(net.minecraft.client.particle.ParticleSuspendedTown.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("crit")) {
        entityfx = create(net.minecraft.client.particle.ParticleCrit.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("magicCrit")) {
        entityfx = create(net.minecraft.client.particle.ParticleCrit.MagicFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("smoke")) {
        entityfx = create(net.minecraft.client.particle.ParticleSmokeNormal.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("mobSpell")) {
        entityfx = create(net.minecraft.client.particle.ParticleSpell.MobFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("mobSpellAmbient")) {
        entityfx = create(net.minecraft.client.particle.ParticleSpell.AmbientMobFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("spell")) {
        entityfx = create(net.minecraft.client.particle.ParticleSpell.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("instantSpell")) {
        entityfx = create(net.minecraft.client.particle.ParticleSpell.InstantFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("witchMagic")) {
        entityfx = create(net.minecraft.client.particle.ParticleSpell.WitchFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("note")) {
        entityfx = create(net.minecraft.client.particle.ParticleNote.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("portal")) {
        entityfx = create(net.minecraft.client.particle.ParticlePortal.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("enchantmenttable")) {
        entityfx = create(net.minecraft.client.particle.ParticleEnchantmentTable.EnchantmentTable::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("explode")) {
        entityfx = create(net.minecraft.client.particle.ParticleExplosion.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("flame")) {
        entityfx = create(net.minecraft.client.particle.ParticleFlame.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("lava")) {
        entityfx = create(net.minecraft.client.particle.ParticleLava.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("footstep")) {
        entityfx = create(net.minecraft.client.particle.ParticleFootStep.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("splash")) {
        entityfx = create(net.minecraft.client.particle.ParticleSplash.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("wake")) {
        entityfx = create(net.minecraft.client.particle.ParticleWaterWake.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("largesmoke")) {
        entityfx = create(net.minecraft.client.particle.ParticleSmokeLarge.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("cloud")) {
        entityfx = create(net.minecraft.client.particle.ParticleCloud.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("reddust")) {
        entityfx = create(net.minecraft.client.particle.ParticleRedstone.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("snowballpoof")) {
        entityfx = create(net.minecraft.client.particle.ParticleBreaking.SnowballFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("dripWater")) {
        entityfx = create(net.minecraft.client.particle.ParticleDrip.WaterFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("dripLava")) {
        entityfx = create(net.minecraft.client.particle.ParticleDrip.LavaFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("snowshovel")) {
        entityfx = create(net.minecraft.client.particle.ParticleSnowShovel.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("slime")) {
        entityfx = create(net.minecraft.client.particle.ParticleBreaking.SlimeFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("heart")) {
        entityfx = create(net.minecraft.client.particle.ParticleHeart.Factory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("angryVillager")) {
        entityfx = create(net.minecraft.client.particle.ParticleHeart.AngryVillagerFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.equalsIgnoreCase("happyVillager")) {
        entityfx = create(net.minecraft.client.particle.ParticleSuspendedTown.HappyVillagerFactory::new, (World)mc.world, x, y, z, mx, my, mz, new int[0]);
      } else if (type.startsWith("iconcrack")) {
        entityfx = create(net.minecraft.client.particle.ParticleBreaking.Factory::new, (World)mc.world, x, y, z, mx, my, mz, params);
  ...
  public static void spawnMarkPoint(EntityPlayer player, double x, double y, double z) {
    ...
    (FMLClientHandler.instance().getClient()).effectRenderer.addEffect((Particle)markPoint);
  }
