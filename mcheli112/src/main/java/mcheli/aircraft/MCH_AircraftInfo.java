...
public abstract class MCH_AircraftInfo extends MCH_BaseInfo implements IItemContent {
  ...
  public boolean validate() throws Exception {
    if (this.cameraPosition.size() <= 0)
      ...
      //this.cameraPosition.add(new CameraPosition(Vec3d));
                    ...
                    if(item.equalsIgnoreCase("SetWheelPos")) {
                      ...
                      if(s.length >= 4) {
                        ...
                        for(var22 = 2; var22 < s.length; ++var22) {
                          //this.wheels.add(new MCH_AircraftInfo.Wheel(Vec3d.createVectorHelper((double)var15, (double)var18, (double)this.toFloat(s[var22]))));
                          this.wheels.add(new Wheel(this, new Vec3d(var15, var18, toFloat(s[var22]))));
                                    ...
                                    if(!item.equalsIgnoreCase("AddPartLG") && !item.equalsIgnoreCase("AddPartSlideRotLG") && !item.equalsIgnoreCase("AddPartLGRev") && !item.equalsIgnoreCase("AddPartLGHatch")) {
                                      ...
                                      if(!item.equalsIgnoreCase("AddPartSlideRotLG") && s.length >= 6) {
                                        ...
                                        if(s.length >= 8) {
                                          ...
                                          var42.rot2 = new Vec3d((double)this.toFloat(s[7]), (double)this.toFloat(s[8]), (double)this.toFloat(s[9]));
                                        }
                                      ...
                                      if(item.equalsIgnoreCase("AddPartSlideRotLG") && s.length >= 9) {
                                        ...
                                        var42.slide = new Vec3d((double)this.toFloat(s[0]), (double)this.toFloat(s[1]), (double)this.toFloat(s[2]));
                                        this.landingGear.add(var42);
                                      }
                                    }
                                  } else {
  ...
  public class DrawnPart {
    ...
    public DrawnPart(float px, float py, float pz, float rx, float ry, float rz, String name) {
      //this.pos = Vec3d.createVectorHelper((double)px, (double)py, (double)pz);
      //this.rot = Vec3d.createVectorHelper((double)rx, (double)ry, (double)rz);
