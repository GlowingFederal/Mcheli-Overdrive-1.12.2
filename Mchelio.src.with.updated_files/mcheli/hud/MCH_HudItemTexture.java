...
public class MCH_HudItemTexture extends MCH_HudItem {
  ...
  public void execute() {
    ...
    drawTexture(this.name, centerX + calc(this.left), centerY + calc(this.top), calc(this.width), calc(this.height), 
        calc(this.uLeft), calc(this.vTop), calc(this.uWidth), calc(this.vHeight), (float)calc(this.rot), this.textureWidth, this.textureHeight);
  }
}
