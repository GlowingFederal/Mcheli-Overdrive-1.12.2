...
/* 20 */     this.value = v;
/* 21 */     this.name = n.toUpperCase();
/* 22 */     this.description = d;
/*    */   }
/*    */ 
/*    */   
/*    */   public static int getValue(String name) {
/* 27 */     String n = name.toUpperCase();
/* 28 */     for (MCH_KeyName key : list) {
/*    */       
/* 30 */       if (key.name.compareTo(n) == 0)
/*    */       {
/* 32 */         return key.value;
/*    */       }
/*    */     } 
...
/* 40 */     for (MCH_KeyName key : list) {
/*    */       
/* 42 */       if (key.value == value)
/*    */       {
/* 44 */         return key.name;
/*    */       }
/*    */     } 
...
/* 52 */     for (MCH_KeyName key : list) {
/*    */       
/* 54 */       if (key.value == value)
/*    */       {
/* 56 */         return key.description;
/*    */       }
/*    */     } 
/* 59 */     return "";
/*    */   }
...
/* 64 */     for (MCH_KeyName key : list) {
/*    */       
/* 66 */       if (key.value == value)
/*    */       {
/* 68 */         return key.description.isEmpty() ? key.name : key.description;
/*    */       }
/*    */     } 
/* 71 */     return "";
/*    */   }
...
/* 76 */     return getDescOrName(W_KeyBinding.getKeyCode(key));
/*    */   }
/*    */   
...
/* Location:              C:\Users\leo\Downloads\Mchelioreal\!\mcheli\MCH_KeyName.class
