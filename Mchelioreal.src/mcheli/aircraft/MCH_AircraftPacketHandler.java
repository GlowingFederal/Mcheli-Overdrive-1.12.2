...
/*   35 */     if (player == null || player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*   40 */     MCH_PacketIndRotation req = new MCH_PacketIndRotation();
/*   41 */     req.readData(data);
/*      */     
/*   43 */     if (req.entityID_Ac <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  129 */     if (player == null || !player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  134 */     MCH_PacketNotifyOnMountEntity req = new MCH_PacketNotifyOnMountEntity();
/*  135 */     req.readData(data);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  194 */     if (player == null || !player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  199 */     MCH_PacketNotifyAmmoNum status = new MCH_PacketNotifyAmmoNum();
/*  200 */     status.readData(data);
/*      */     
/*  202 */     if (status.entityID_Ac <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  288 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  293 */     MCH_PacketStatusRequest req = new MCH_PacketStatusRequest();
/*  294 */     req.readData(data);
/*      */     
/*  296 */     if (req.entityID_AC <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  320 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  325 */     MCH_PacketIndNotifyAmmoNum req = new MCH_PacketIndNotifyAmmoNum();
/*  326 */     req.readData(data);
/*      */     
/*  328 */     if (req.entityID_Ac <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  366 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  371 */     MCH_PacketIndReload ind = new MCH_PacketIndReload();
/*  372 */     ind.readData(data);
/*      */     
/*  374 */     if (ind.entityID_Ac <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  413 */     MCH_PacketStatusResponse status = new MCH_PacketStatusResponse();
/*  414 */     status.readData(data);
/*      */ 
/*      */ 
/*      */     
/*  418 */     if (status.entityID_AC <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  479 */     if (!player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  484 */     MCH_PacketNotifyWeaponID status = new MCH_PacketNotifyWeaponID();
/*  485 */     status.readData(data);
/*      */     
/*  487 */     if (status.entityID_Ac <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  570 */     if (!player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  575 */     MCH_PacketNotifyHitBullet status = new MCH_PacketNotifyHitBullet();
/*  576 */     status.readData(data);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  613 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  618 */     MCH_PacketSeatListRequest req = new MCH_PacketSeatListRequest();
/*  619 */     req.readData(data);
/*      */     
/*  621 */     if (req.entityID_AC <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  646 */     if (player.field_70170_p.field_72995_K) {
/*      */       
/*  648 */       MCH_PacketNotifyTVMissileEntity packet = new MCH_PacketNotifyTVMissileEntity();
/*  649 */       packet.readData(data);
/*      */       
/*  651 */       if (packet.entityID_Ac <= 0) {
/*      */         return;
/*      */       }
/*  654 */       if (packet.entityID_TVMissile <= 0) {
/*      */         return;
/*      */       }
/*      */ 
/*      */ 
...
/*  701 */     if (!player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  706 */     MCH_PacketSeatListResponse seatList = new MCH_PacketSeatListResponse();
/*  707 */     seatList.readData(data);
/*      */     
/*  709 */     if (seatList.entityID_AC <= 0) {
/*      */       return;
/*      */     }
/*      */ 
/*      */ 
...
/*  773 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */     
/*  777 */     MCH_PacketSeatPlayerControl pc = new MCH_PacketSeatPlayerControl();
/*  778 */     pc.readData(data);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  880 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  885 */     MCH_PacketNotifyClientSetting pc = new MCH_PacketNotifyClientSetting();
/*  886 */     pc.readData(data);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  928 */     if (player.field_70170_p.field_72995_K) {
/*      */       return;
/*      */     }
/*      */ 
/*      */     
/*  933 */     MCH_PacketNotifyInfoReloaded pc = new MCH_PacketNotifyInfoReloaded();
/*  934 */     pc.readData(data);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              C:\Users\leo\Downloads\Mchelioreal\!\mcheli\aircraft\MCH_AircraftPacketHandler.class
