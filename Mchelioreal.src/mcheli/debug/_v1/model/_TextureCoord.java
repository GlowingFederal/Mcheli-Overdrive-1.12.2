...
/* 34 */     stream.println(String.format("T: [%.6f, %.6f, %.6f]", new Object[] { Float.valueOf(this.u), Float.valueOf(this.v), Float.valueOf(this.w) }));
/*    */   }
/*    */ }


/* Location:              C:\Users\leo\Downloads\Mchelioreal\!\mcheli\debug\_v1\model\_TextureCoord.class
